...
<body>
  <nav class="navbar navbar-expand-lg navbar-light shadow-sm" style="background-color:palegreen;">
    <div class="container-fluid">
      <a class="navbar-brand" href="<?= base_url('/'); ?>/">SPBU GIUDE</a>
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?= base_url('/viewmap'); ?>/">Maps</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?= base_url('/learn'); ?>/">About us</a>
          </li>
          <li class="nav-item">
      ...
      <a href="<?= base_url('login'); ?>/" class="btn btn-outline-dark">Admin</a>
    </div>
